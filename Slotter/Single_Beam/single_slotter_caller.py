...
#the input is actually the tape data itslef because then it goes into the directory of tape
...
node = args.n
tape_no = args.t
code = '/home/aga017/codes/csiro/Slotter/Single_Beam/single_beam_slotter.py'
